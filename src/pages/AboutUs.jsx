...
const AboutUs = () => {
  return (
    <div className="about-us">
      {/* Header Section */}
      <section
        className="relative bg-cover bg-center h-[40rem] h-screen flex flex-col justify-center items-center text-center overflow-hidden"
      ...
      <section className="py-16 px-4 md:px-8 lg:px-16">
        <div className="max-w-6xl mx-auto text-center">
          <h2 className="md:text-4xl sm:text-3xl text-2xl font-semibold mb-10 flex justify-center items-center">
            Meet the Team
          </h2>
        ...
        <div className="max-w-4xl mx-auto lg:text-left">
          <div className="flex flex-col lg:flex-row items-center lg:items-start gap-8">
            <div className="flex-shrink-0">
              ...
              <p className="text-gray-600 text-left">Founder @CoolCuts</p>
            </div>
            <div className="text-center lg:text-left">
              <h3 className="text-xl mt-4 font-semibold">About Owner</h3>
